...
const Footer = () => {
    ...
    <a href="https://flowbite.com/" className="flex flex-col items-start">
        <Image src={LogoFooter} alt="logo" height={100} width={150} />
        <span className="self-start text-sm text-white mt-2 w-[500px] h-[120px] overflow-hidden overflow-y-auto">
            Trong niềm hân hoan mừng kính Thánh Phanxicô Assisi – Bổn mạng gia đình Học viện, Học xá Học viện đã long trọng cử hành Thánh lễ tạ ơn mừng kính Thánh Bổn mạng vào lúc 10g00 thứ Bảy, ngày 05.10.2024.
        </span>
    </a>
</div>
