...
export const fakePosts = [
    {
        ...
        excerpt: "Một bài viết chi tiết về cách sử dụng Next.js trong dự án của bạn."
    },
    {
        ...
        excerpt: "Khám phá những tính năng nổi bật của React trong phát triển ứng dụng."
    },
            ...
            {fakePosts.map((post) => {
                ...
                return (
                    <div
                        ...
                        className={cx("group cursor-pointer", minimal && "grid gap-10 md:grid-cols-2")}
                    >
                        ...
                        <div className={cx(minimal && "flex items-center")}>
                            <div>
                                ...
                                <div className="mt-3 flex items-center space-x-3 text-gray-500 ">
                                    ...
                                    >
                                        {/*{format(parseISO(post.publishedAt), "MMMM dd, yyyy")}*/}24/12/2024
                                    </time>
                                </div>
                            </div>
                        </div>
